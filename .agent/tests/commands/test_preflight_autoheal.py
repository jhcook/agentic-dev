...
from tests.core.preflight.test_healer import TestHealer, _FILE_RE
...
def test_test_healer_pii_scrubbed_before_ai():
    ...
    with patch("tests.core.preflight.test_healer.scrub_sensitive_data", return_value="[SCRUBBED]") as mock_scrub, \
