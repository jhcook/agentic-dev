...
# ---------------------------------------------------------------------------
# Block assembly helpers — split to runbook_assembler.py (INFRA-145 LOC budget)
# Re-exported here for backward compatibility.
# ---------------------------------------------------------------------------

from agent.commands.runbook_assembler import (  # noqa: E402,F401
...
# ---------------------------------------------------------------------------
# Post-processing passes — split to runbook_postprocess.py (INFRA-145 LOC budget)
# Re-exported here for backward compatibility.
# ---------------------------------------------------------------------------

from agent.commands.runbook_postprocess import (  # noqa: E402,F401
    _autocorrect_schema_violations,
    _normalize_list_markers,
    _fix_changelog_sr_headings,
    _ensure_blank_lines_around_fences,
    _rebalance_fences,
