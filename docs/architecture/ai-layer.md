...
- **providers.py**: Serves as the factory layer containing the generic base implementations, `AnthropicProvider`, as well as the dynamic `ProviderRegistry` which permits fast local-model onboarding. 
